...
class WhiteboxRNNCounterexampleGenerator:
    ...
    def _get_counterexample_from(self,words):
        ...
        for w in words:
            ...
            if prop_class is not None and self.whiteboxrnn.classify_word(w) != prop_class:
                return w
        return None
    ...
    def _add_children_states(self,cluster):
        ...
        if not state_info.explored:
            ...
            for char in self.proposed_dfa.alphabet:
                next_RState, output_label = self.whiteboxrnn.get_next_RState(RState, char)
    ...
    def _initialise_unrolling(self):
        ...
        initial_RState, output_label = self.whiteboxrnn.get_first_RState()
